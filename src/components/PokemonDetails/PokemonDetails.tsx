import { IconButton, Dialog, DialogTitle, DialogContent, Button, DialogActions, Paper, Card } from "@mui/material"
...
export const PokemonDetails = () => {
    ...
    return <Dialog open onClose={onClose} className={classes.dialog}>
        <DialogTitle>
                ...
                <div className={classes.contentOuterContainer}>
                    <div className={classes.contentRowContainer}>
                        ...
                        <Paper className="otherStats">
                            ...
                            <div className="dataContainer">Classification: {pokemon.classification}</div>
